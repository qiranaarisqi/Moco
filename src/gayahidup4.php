    ...
    <div class="flex flex-col lg:flex-row w-full gap-10">
        ...
        <div class="lg:w-8/12">
            ...
            <p class="mt-6 text-base lg:text-xl leading-relaxed text-justify">
                ...
                <br><br>
             Warna bold dan kepercayaan diri Bagi Defria, keberanian seseorang memakai warna-warna bold bukan sekadar soal gaya, melainkan juga soal rasa percaya diri.
             Padukan warna kontras Salah satu kunci utama dalam mix & match warna bold adalah mengatur kontras.  Saat seseorang memilih warna terang seperti maroon atau fuchsia, warna pasangannya sebaiknya dibuat lebih gelap atau lebih sederhana agar warna utama tetap menonjol.
        <!-- Berita Terbaru -->
