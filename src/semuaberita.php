...
<div class=" flex flex-col gap-5 px-4 lg:px-14">
  <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
    <a href="pariwisata1.php">
      <div
        ...
        <p class="font-bold text-base mb-1">Trend Turis Indonesia ke Liburan Luar Negeri</p>
        <p class="text-slate-400">22 November 2026</p>
      </div>
    </a>
    <a href="olahraga2.php">
      <div
        class="border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer transition duration-300 ease-in-out">
        <div class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Olahraga</div>
        <img src="img/olahraga2.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">Jadwal BWF World Tour Finals 2025<br>: Indonesia Punya 5 Wakil </p>
        <p class="text-slate-400">26 November 2026</p>
      </div>
    </a>
    <a href="gayahidup2.php">
      <div
        class="border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer transition duration-300 ease-in-out">
        ...
        <p class="font-bold text-base mb-1">Kapan tubuh butuh Botox 
        <p class="text-slate-400">22 November 2026</p>
      </div>
    </a>
    <a href="kesehatan1.php">
      <div
        ...
        <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Kesehatan</div>
        <img src="img/kesehatan1.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">Uji Klinis Vaksin Dengue Tahap Lanjut Diluncurkan di Jakarta
        <p class="text-slate-400">22 November 2026</p>
      </div>
    </a>
  </div>
  ...
  <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
    ...
    <a href="gayahidup1.php">
      <div
        class="border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer transition duration-300 ease-in-out">
        <div class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Gaya Hidup</div>
        <img src="img/gayahidup1.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">7 Kebisaaan Tidur
        <p class="text-slate-400">22 November 2026</p>
      </div>
    </a>
  ...
  <div class="w-full flex items-center justify-center gap-3 pt-12 mb-10">
    <p class="border border-slate-300 rounded-lg px-4 py-2 font-medium text-slate-300">&lt;</p>
    <p class="rounded-lg px-4 py-2 font-medium bg-primary text-white hover:bg-slate-300 hover:text-black">1</p>
    <p
