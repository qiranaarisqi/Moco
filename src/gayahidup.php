  ...
  <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
    <a href="gayahidup1.php">
      <div
        ...
        <p class="font-bold text-base mb-1">7 Kebisaaan Tidur</p>
    ...
    <a href="gayahidup2.php">
      <div
        ...
        <p class="font-bold text-base mb-1">Kapan tubuh butuh Botox <br>Dikarenakan Kenaikan BBM</p>
        <p class="text-slate-400">23 November 2026</p>
      </div>
    </a>
    <a href="gayahidup3.php">
      <div
        ...
        <p class="font-bold text-base mb-1">3 Basic Skincare Pria Menurut Dokter, Tidak Ribet 
        <p class="text-slate-400">25 November 2026</p>
      </div>
    </a>
    <a href="gayahidup4.php">
      <div
        ...
        <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Gaya Hidup</div>
        <img src="img/gayahidup4.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">3 Tips Mix and Match Baju Warna Bold untuk Tampilan Lebih Stand Out
