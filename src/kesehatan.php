<?php
$pageTitle = "Kesehatan - Moco";
include 'includes/header.php';
?>

<!-- Header -->
<div class="w-full mb-16 bg-[#F6F6F6]">
  <h1 class="text-center font-bold text-2xl p-24">Kesehatan</h1>
</div>
  ...
  <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
    <a href="kesehatan1.php">
      <div
        ...
        <p class="font-bold text-base mb-1">Uji Klinis Vaksin Dengue Tahap Lanjut Diluncurkan di Jakarta</p>
