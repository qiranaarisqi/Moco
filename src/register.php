<?php
$pageTitle = "Register - Moco";
// Untuk halaman register, kita tidak include header.php karena desainnya berbeda
?>
<!DOCTYPE html>
<html lang="id">
...
<body class="flex items-center justify-center min-h-screen bg-[#FFF8F2]">
  <div class="flex flex-col items-center justify-center bg-white p-8 mt-8 mb-8 rounded-lg w-full max-w-lg py-20">
    ...
    <!-- Form Section -->
    <form action="proses_register.php" method="POST" class="w-full">
      <div class="flex flex-col w-full mb-7 gap-y-3">
        <label for="nama" class="text-slate-400 font-semibold">Nama</label>
        <input type="text" id="nama" name="nama" placeholder="Masukan Nama Kamu"
      ...
      <div class="flex flex-col w-full mb-7 gap-y-3">
        ...
        <textarea id="bio" name="bio" placeholder="Ceritakan tentang dirimu.."
      ...
      <div class="flex flex-col w-full mb-7 gap-y-3">
        ...
        <input type="password" id="password" name="password" placeholder="Ketik Password Kamu"
      ...
      <div class="flex flex-col w-full mb-7 gap-y-3">
        <label for="confirm_password" class="text-slate-400 font-semibold">Konfirmasi Password</label>
        <input type="password" id="confirm_password" name="confirm_password" placeholder="Ketik Ulang Password Kamu"
          class="p-2 rounded-xl font-medium border border-slate-300 focus:ring-1 focus:border-none focus:ring-primary focus:outline-none transition duration-300 ease-in-out"
          required>
      </div>
      <!-- Submit Button -->
    ...
    <div class="mt-6 text-center">
      <p class="text-slate-500">
        Sudah punya akun? 
        <a href="login.php" class="text-primary font-semibold hover:underline">Masuk di sini</a>
      </p>
    </div>
  </div>
</body>
