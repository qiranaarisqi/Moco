  ...
  <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
    ...
    <div
      ...
      <a href="pariwisata2.php">
        ...
        <img src="img/pariwisata2.png" alt="berita1" class="rounded-2xl">
        <p class="font-bold text-xl mt-3">4 Rekomendasi Wisata di Banyuwangi, Cocok untuk Libur Akhir Tahun
           </p>
        <p class="text-slate-400 text-base mt-1">Kepala Dinas Kebudayaan dan Pariwisata Banyuwangi Taufik Hidayat mengatakan biasanya terjadi peningkatan jumlah kunjungan wisatawan ke Banyuwangi hingga dua kali lipat pada libur akhir tahun dibanding hari biasa.</p>
        <p class="text-slate-400 text-base mt-1">26 November 2026</p>
      </a>
    </div>

    <!-- Berita 1 -->
    <a href="kesehatan1.php"
      ...
      <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 absolute text-sm">
        Kesehatan</div>
      <img src="img/kesehatan1.png" alt="berita2" class="rounded-xl w-full md:max-h-48">
      <div class="mt-2 md:mt-0">
        <p class="font-semibold text-lg">Uji Klinis Vaksin Dengue Tahap Lanjut Diluncurkan di Jakarta</p>
        <p class="text-slate-400 mt-3 text-sm font-normal">
          Uji klinis tahap lanjut untuk pengembangan vaksin dengue buatan perusahaan farmasi MSD diluncurkan di Jakarta, Selasa (25/11/2025).</p>
      </div>
    </a>

    <!-- Berita 2 -->
    <a href="gayahidup4.php"
      class="relative col-span-5 flex flex-col h-fit md:flex-row gap-3 border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer">
      <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 absolute text-sm">Gaya
        Hidup</div>
      <img src="img/gayahidup4.png" alt="berita2" class="rounded-xl w-full md:max-h-48">
      <div class="mt-2 md:mt-0">
        <p class="font-semibold text-lg">Tips Mix and Match Baju Warna Bold untuk Tampilan Lebih Stand Out</p>
        <p class="text-slate-400 mt-3 text-sm font-normal">kunci utama saat bermain warna bold bukan hanya soal keberanian</p>
      </div>
    </a>
    ...
    <a href="detail-MotoGp.php"
      ...
      <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 absolute text-sm">
        Olahraga</div>
      <img src="img/olahraga2.png" alt="berita2" class="rounded-xl w-full md:max-h-48">
      <div class="mt-2 md:mt-0">
        <p class="font-semibold text-lg">Jadwal BWF World Tour Finals 2025: Indonesia Punya 5 Wakil</p>
        <p class="text-slate-400 mt-3 text-sm font-normal">
          Tim bulu tangkis Indonesia meloloskan lima wakil ke BWF World Tour Finals 2025</p>
      </div>
    </a>
  </div>
  ...
  <div class="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
    ...
    <a href="author.php">
      <div
        ...
        <img src="img/author1.png" alt="" class="rounded-full w-24 h-24">
        <p class="font-bold text-xl mt-4">jaehyun</p>
        <p class="text-slate-400">3 Berita</p>
      </div>
    </a>
    <!-- Author 2 -->
    <a href="author.php">
      <div
        ...
        <p class="text-slate-400">2 Berita</p>
      </div>
    </a>
    ...
    <a href="author.php">
      <div
        class="flex flex-col items-center border border-slate-200 px-4 py-8 rounded-2xl hover:border-primary hover:cursor-pointer">
        <img src="img/profile.png" alt="" class="rounded-full w-24 h-24">
        <p class="font-bold text-xl mt-4">Fransisca</p>
        <p class="text-slate-400">4 Berita</p>
      </div>
    </a>
    ...
    <a href="author.php">
      <div
        class="flex flex-col items-center border border-slate-200 px-4 py-8 rounded-2xl hover:border-primary hover:cursor-pointer">
        <img src="img/profile.png" alt="" class="rounded-full w-24 h-24">
        <p class="font-bold text-xl mt-4">Ardito</p>
        <p class="text-slate-400">2 Berita</p>
      </div>
    </a>
  ...
  <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
    ...
    <a href="detail-MotoGp.php">
      <div
        ...
        <div class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Politik</div>
        <img src="img/politik1.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">KPK Sita Rumah <br>Dikarenakan Kenaikan BBM</p>
        <p class="text-slate-400">22 Januari 2024</p>
      </div>
    </a>
    <a href="detail-MotoGp.php">
      <div
        ...
        <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Olahraga</div>
        <img src="img/olahraga2.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">Jadwal BWF World Tour Finals 2025: Indonesia Punya 5 Wakil <br>Sirkuit Mandalika</p>
        <p class="text-slate-400">22 Januari 2024</p>
      </div>
    </a>
    <a href="detail-MotoGp.php">
      <div
        ...
        <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 text-sm absolute">
          Gaya Hidup</div>
        <img src="img/gayahidup2.png" alt="" class="w-full rounded-xl mb-3">
        <p class="font-bold text-base mb-1">MKapan tubuh butuh Botox <br>Menumbuhkan Koneksi</p>
        <p class="text-slate-400">22 Januari 2024</p>
      </div>
    </a>
  </div>
