  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      <a href="detail-MotoGp.php" class="block">
        <div
          class="relative flex flex-col gap-1 justify-end p-3 h-72 rounded-xl bg-[url('../img/politik1.png')] bg-cover bg-center overflow-hidden">
          <div
          ...
          <div class="relative z-10 mb-3" style="padding-left: 10px;">
            ...
            <div class="flex items-center gap-1 mt-1">
              <img src="../img/politik1.png" alt="Muhamad Rafli" class="w-5 h-5 rounded-full">
