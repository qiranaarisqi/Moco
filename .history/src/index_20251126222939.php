  ...
  <a href="politik1.php" class="block">
    ...
    <div class="swiper-slide">
      <a href="gayahidup1.php" class="block">
        <div
          class="relative flex flex-col gap-1 justify-end p-3 h-72 rounded-xl bg-[url('./img/gayahidup1.png')] bg-cover bg-center overflow-hidden">
          <div
          ...
          <div class="relative z-10 mb-3" style="padding-left: 10px;">
            ...
            <div class="flex items-center gap-1 mt-1">
              <img src="./img/gayahidup1.png" alt="" class="w-5">
              <p class="text-white text-xs">Muhamad Rafli</p>
            </div>
          </div>
        </div>
