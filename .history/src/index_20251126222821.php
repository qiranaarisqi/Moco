...
<div class="swiper mySwiper mt-9">
  ...
  <a href="detail-MotoGp.php" class="block">
    <div
      ...
      <!-- Gradient full height untuk coverage lebih baik -->
      <div
        class="absolute inset-x-0 bottom-0 h-full bg-gradient-to-t from-[rgba(0,0,0,0.7)] via-[rgba(0,0,0,0.3)] to-[rgba(0,0,0,0)] rounded-b-xl">
      </div>
      <div class="relative z-10 mb-3" style="padding-left: 10px;">
        <div class="bg-green-500 text-white text-xs rounded-lg w-fit px-3 py-1 font-normal mt-3">Pariwisata</div>
        <p class="text-2xl font-semibold text-white mt-1 leading-tight">7 Bahaya Tidur Setelah Makan,</p>
        <p class="text-2xl font-semibold text-white mt-1 leading-tight">Jangan Sepelekan Kebiasaan Ini</p>
        <div class="flex items-center gap-1 mt-2">
          <!-- Gunakan gambar avatar author, bukan gambar kategori -->
          <img src="./img/author-avatar.png" alt="Muhamad Rafli" class="w-6 h-6 rounded-full">
          <p class="text-white text-xs">Muhamad Rafli</p>
        </div>
      </div>
    </div>
